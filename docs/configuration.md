...
| `cloudCoverEntity` | string | — | A `weather` entity (its `cloud_coverage`) or a cloud cover sensor in %. Cloud thins direct sunlight to a quarter at full cover and ambient daylight to 70%; unreadable dims nothing. See [Clouds](lighting.md#clouds). |
